...
import institution_route from "./routes/institution/institutionRouter";
import project_route from "./routes/project/projectRouter";
...
export function express_routes(this: REST_Host): Router {
    ...
    // institution routes
    this.expressApp.use(institution_route());

    // project routes
    this.expressApp.use(project_route());
