...
const BeforeDrag = () => {
  return (
    <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1em", color: colors.primary[800] }}>
      <CloudUpload style={{ fontSize: 80 }}/>
      <Typography fontWeight="bold" fontSize="1.2em">Drag and drop or browse files</Typography>
    </Box>
  )
}
...
const DuringDrag = () => {
  return (
    <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1em", color: colors.primary[500] }}>
      <CloudDone style={{ fontSize: 80 }}/>
      <Typography fontWeight="bold" fontSize="1.2em">Drop files here</Typography>
    </Box>
  )
}
