...
const ModelsGrid = ({
  models, path, selectedAtlas = null, selectedModel = null, handleModelSelection = null,
}) => (
      ...
      {models && models.map((model) => (
        <Grid key={model._id} item xs={12} sm={6} md={4} lg={3}>
          <ModelCard
            ...
            disabled={selectedAtlas && !selectedAtlas.compatibleModels.some(
              (element) => element.toLowerCase() === model.name.toLowerCase(),
            )}
          />
        </Grid>
      ))}
