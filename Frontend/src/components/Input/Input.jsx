...
const Input = (props) => { 
  ...
  const {id,helperText, placeholder, errorHandler, disabledHandler, isRequired=false, defaultValue, multiline=false, onChangeEvent=null, onBlurEvent=null, onFocusEvent=null, label='Required', maxLength=40, type='text'} = props
  return (
  <Box
    component="form"
    sx={{
